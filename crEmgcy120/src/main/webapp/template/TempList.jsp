...
<html>
 ...
 <body>
<center>
<form name="form1" method="post" action="<%=basePath%>/proSendWb/proSendWbList.do">
...
<table width="98%"  border="0" cellspacing="1" cellpadding="0" height="30">
    <tr>
        <td> <%-- 按钮--%>
		     ...
		     <img src="<%=basePath%>images/report/tgsh.gif" onclick="toSubmit('edit')" style="cursor: pointer;">&nbsp;
		     <img src="<%=basePath%>images/report/btgsh.gif" onclick="toSubmit('del')" style="cursor: pointer;">
		</td> 
		<%-- 分页面公共页面 --%>
